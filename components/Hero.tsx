    ...
    <div className="pb-10 pt-20">
      ...
      <div className="flex justify-center relative my-10 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
           ...
           */}
          <TextGenerateEffect
            words="Turning Global Insights into Scalable Software"
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
          />

          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Full-stack engineer with a global perspective. I build for audiences
            most engineers overlook—most recently scaling a SaaS to 10K users
            and 3-figure MRR in 4 months.
          </p>
